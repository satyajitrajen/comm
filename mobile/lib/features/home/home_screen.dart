            ...
            child: ListView(
              ...
              children: [
                ...
                Wrap(
                  ...
                  runSpacing: 8,
                  children: [
                    _stat('Unread', '${d['unreadCount'] ?? 0}'),
                    _stat('Tasks', '${d['openTaskCount'] ?? 0}'),
                    _stat('Files', '${d['fileCount'] ?? 0}'),
                    _stat('Events', '${d['upcomingEventCount'] ?? 0}'),
                  ],
                ),
                ...
                const SizedBox(height: 16),
                const Text('Upcoming', style: TextStyle(fontWeight: FontWeight.w600)),
                ...((d['upcomingEvents'] as List?) ?? []).take(5).map((raw) {
